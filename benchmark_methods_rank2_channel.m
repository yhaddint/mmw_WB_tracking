...
% Channel has multiple (2) multipath clusters
...
figure
plot(angle_rx_range(rx_opt_index(:,1))/pi*180,'linewidth',2);hold on
plot(phi_array(1,:)/pi*180,'linewidth',2);hold on
plot(mean(rayAOA_true_BB1,2)/pi*180,'linewidth',2);hold on
plot(angle_rx_range(rx_opt_index(:,2))/pi*180,'linewidth',2);hold on
plot(phi_array(2,:)/pi*180,'linewidth',2);hold on
plot(mean(rayAOA_true_BB2,2)/pi*180,'linewidth',2);hold on
title('AOA')
legend('refine1','NB1','True AOA1','refine2','NB2','True AOA2')
grid on
